...
%Get the solutions file
[filename pathname] = uigetfile('*mat', 'Pick solutions file');
solutionFile = fullfile(pathname, filename);

%Start the frameCount, keep empty timeStamp array, start the table emptyst
frameCount = 1;
timeStamps = [];
